...
(defn solve
  [& args]
  (let [input (get-input "inputs/2020/day11.txt")]
    {:part1 (get (frequencies (vals (update-seats input get-neighbors 4))) \#)
     :part2 (get (frequencies (vals (update-seats input get-visible 5))) \#)}))
